...
import { Printer, Archive, ListOrdered, BarChart3, Cloud, Settings, Sun, Moon, Monitor, ChevronLeft, ChevronRight, Keyboard, Github, ArrowUpCircle, Wrench, FolderKanban, FolderOpen, X, Menu, Info, Plug, Bug, LogOut, Key, Loader2, Disc3, ShieldAlert, Globe, ShoppingBag, type LucideIcon } from 'lucide-react';
...
export const defaultNavItems: NavItem[] = [
  ...
  { id: 'shopee', to: '/shopee', icon: ShoppingBag, labelKey: 'nav.shopee' },
